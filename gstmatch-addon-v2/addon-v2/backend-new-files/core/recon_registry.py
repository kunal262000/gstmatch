...
RECON_TYPES: dict[str, ReconTypeConfig] = {
    ...
    "gstr1_vs_gstr3b": ReconTypeConfig(
        id="gstr1_vs_gstr3b",
        name="GSTR-1 vs GSTR-3B",
        short_name="GSTR-1 vs GSTR-3B",
        description="Cross-verify turnover and tax liability between returns — same engine, reversed file order.",
        icon="🔗",
        engine="summary",
        file1_label="GSTR-1 File",
        file2_label="GSTR-3B File",
        file1_hint="GST Portal → Returns → GSTR-1 → Download Summary (Excel/JSON)",
        file2_hint="GST Portal → Returns → GSTR-3B → Download Summary (Excel/JSON)",
        file1_parser=parse_gstr1_summary,
        file2_parser=parse_gstr3b_summary,
    ),
