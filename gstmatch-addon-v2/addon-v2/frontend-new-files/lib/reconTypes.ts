...
export const RECON_TYPES: ReconTypeInfo[] = [
  ...
  },
  {
    ...
    shortName: 'GSTR-1 vs GSTR-3B',
    description: 'Cross-verify turnover and tax liability between returns.',
    icon: '🔗',
    engine: 'summary',
    file1Label: 'GSTR-1 File',
    file2Label: 'GSTR-3B File',
    file1Hint: 'GST Portal → Returns → GSTR-1 → Download Summary (Excel/JSON)',
    file2Hint: 'GST Portal → Returns → GSTR-3B → Download Summary (Excel/JSON)',
  },
  {
    id: 'gstr9_vs_books',
